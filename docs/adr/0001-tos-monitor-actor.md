...
- Related: [`com-junkawasaki/root` ADR-2607110300](https://github.com/com-junkawasaki/root/blob/main/90-docs/adr/2607110300-cloud-itonami-lei-corporate-tos-catalog.edn)
  ...
  (the round-2 10-repo validation batch this repo is part of -- the tenth
  and final repo in this round).

## Context

This repository archives the publicly published legal information of 3M
Company, per ADR-2607110300 -- a read-only reference archive. As part of a
second 10-repo validation batch extending the
...
- **Company**: 3M Company, LEI LUZQVYP4VS22CLWDAR65, website
  `https://www.3m.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  ...
  retrieved-at `2026-07-19`, doc-type `:terms-of-service`.
...
Same as the pilot (ADR-2607241900) and the batch (ADR-2607242300). This
repo completes the round-2 batch of 10, bringing the total to 21/~155
`cloud-itonami-lei-*` repos carrying a governed actor.
