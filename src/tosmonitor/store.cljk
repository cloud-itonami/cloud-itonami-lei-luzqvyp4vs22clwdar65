(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (3M Company, LEI
  LUZQVYP4VS22CLWDAR65) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Legal Information\nThis Legal Information page governs your access to and use of 3M Company websites. By using this site you agree to these terms, which are subject to change without notice. This agreement is governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.3m.com/3M/en_US/company-us/legal-information/"
